...
6. **คลิปไหนไม่มีบทพูด อย่าต่อไฟล์เสียงอ้างอิง** และอย่าประกาศ `<Audio N>` ในพรอมป์ต —
   ref เสียงที่ไม่มีบทคือวิธีที่ H3 ถูกชวนให้แต่งบทพูดขึ้นมาเอง
7. **ลูปยาวให้รันแบบ background** แล้วเฝ้าจากฝั่งที่มองเห็น PID ของ OS นั้นจริงๆ
